...
const styles = StyleSheet.create({
  ...
  groupLabel: { fontSize: 11, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.6, marginTop: 4 },
  ...
  sectionSummary: { fontSize: 11, fontWeight: "400", flexShrink: 1 },
  ...
  bgPillText: { fontSize: 10, fontWeight: "700", color: "#fff" },
  ...
  calDate: { fontSize: 10, fontWeight: "500" },
  calMini: { fontSize: 9, fontWeight: "400" },

  yearCard: { borderRadius: 16, borderWidth: 1, padding: 16 },
  yearMonth: { fontSize: 15, fontWeight: "700", marginBottom: 12 },
  yearStats: { flexDirection: "row", alignItems: "center" },
  yearStatBox: { flex: 1, alignItems: "center", gap: 2 },
  yearStatValue: { fontSize: 18, fontWeight: "700" },
  yearStatUnit: { fontSize: 9, fontWeight: "400", color: "#888" },
  yearStatLabel: { fontSize: 10, fontWeight: "600", color: "#888" },
