/**
 * Surface — the cohesive clinical card used across the Home screen.
 *
 * VISUAL ONLY. Theme-aware fill + a single subtle outer border, with a softer shadow in light mode.
 * Geometry is identical in both themes (only structural color/contrast changes). Semantic content
 * colors are decided by callers, not here.
 */
